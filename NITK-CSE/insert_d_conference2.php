...
<html>
    ...
    $records=$size;
    /*if($size!=2){
         header("Location: insert_d_conference.php?uname=" . $username . "&pw=" . $pass);
    }*/
    ...
    for($i=1;$i<=1;$i++){
        ...
        $sql = "INSERT INTO d_conference Values($ID[$i],'$Description[$i]')";
        echo "";
        if ($mysqli->query($sql) === TRUE) {
                echo "<h1>Record Inserted successfully</h1><br>";
                $link_address="insert_d_conference.php";
