...
<html>
   ...
   /* if($size!=2){
         header("Location: insert_home_table.php?uname=" . $username . "&pw=" . $pass);
    }*/
    for($i=1;$i<=1;$i++){
    ...
    for($i=1;$i<=1;$i++){
        ...
        $sql = "INSERT INTO home_table Values('$section[$i]','$desp[$i]')";

        if ($mysqli->query($sql) === TRUE) {
                echo "<h1>Record Inserted successfully</h1><br>";
                $link_address="insert_home_table.php";
