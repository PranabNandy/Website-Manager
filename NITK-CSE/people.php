...
<html>
    ...
    <div class="d_topmost" style="background-color:rgb(29, 86, 124);height:3.3em;">
        ...
        <div style="font-weight: bold;margin-top:-2em;margin-left:-10%"> Professors</div>
        <?php
$query="select	* from h_faculty where 	h_category='Professors' ";
...
<div style="width:30% ;margin-left:550px">
<div style="font-weight: bold;margin-top:2em;margin-left:-10%"> Head of Department</div>
        <?php
$query="select	* from h_faculty where 	h_category='Head of the Department' ";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
    $teacher=$teacher."<li style='list-style:none;'><a  style='text-decoration: none;margin-left:-22%;font-weight: bold' href='faculty_details.php?sub=".$row1[0]."'>".$row1[1]."</a></li>";
...
<div style="width:30% ;margin-left:800px;">
<div style="font-weight: bold;margin-top:2em;margin-left:-10%">Associate Professors</div>

<?php
$query="select	* from h_faculty where 	h_category='Associate Professors'; ";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
