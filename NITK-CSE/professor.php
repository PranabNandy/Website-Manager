...
<html>
    ...
    <div class="d_topmost" style="background-color:rgb(29, 86, 124);height:3.3em;">
        ...
        <a href="professor.php" id="about" >PROFESSOR</a><br>
              ...
              <div style="width: max-content;margin-left:400px">

              <div style="font-weight: bold;margin-top:-2em;margin-left:-10%"> Assitant Professors</div>
        <?php
$query="select	* from h_faculty where 	h_category='Assistant Professors' ; ";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
    $teacher=$teacher."<li style='list-style:none;'><a style='text-decoration: none;margin-left:-30% ;font-weight: bold' href='faculty_details.php?sub=".$row1[0]."'>".$row1[1]."</a> </li>";
...
?>
              ...
              <div style="font-weight: bold;margin-top:2em;margin-left:-10%"> Adjunct Faculty</div>
              <?php
$query="select	* from h_faculty where 	h_category='Adjunct Faculty' ; ";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
