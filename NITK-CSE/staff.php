...
<div style="font-weight: bold;margin-top:-2em;margin-left:-10%"> Technical Staff</div>
<?php
$query="select	* from h_faculty where 	h_category='Technical Staff'; ";
...
<div style="font-weight: bold;margin-top:2em;margin-left:-10%"> Technical Officer</div>
<?php
$query="select	* from h_faculty where 	h_category='Technical Officer'";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
...
<div style="font-weight: bold;margin-top:2em;margin-left:-10%">  Other Non-Teaching Staff</div>

<?php
$query="select	* from h_faculty where 	h_category='Other Non-Teaching Staff'; ";
$result=mysqli_query($connect,$query);
$teacher= "<ul>";
while($row1=mysqli_fetch_array($result))
{
