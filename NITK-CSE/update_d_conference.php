...
<h2 style="text-align: center;"><a href="login3.php" > ==== > Go To Dashboard Page  < ==== <a></a></h2>
	...
	for($i=1;$i<=$records;$i++){
		...
		$sql = "UPDATE d_conference set  Description='$Description[$i]' WHERE ID=$ID[$i] ";
	...
	?>
	 <div class="login">    
<form id="login" action="update_d_conference.php" method="POST">
	<table id="tb">
		<tr>
			<th>ID</th>
			<th>Description</th>
		...
		$i=1;
  		...
  		?>
			...
			<tr>
				...
				<td><input type="text" size="50" value="<?php echo "$row[1]";?>" name="Description<?php echo "$i";?>"/>
				</td>
