...
<h2 style="text-align: center;"><a href="login3.php" > ==== > Go To Dashboard Page  < ==== <a></a></h2>
	...
	$sql="UPDATE d_publication_year set no_of_publication=$no_of_publication[$i] WHERE year='$year[$i]' ";
	...
	$sql = "SELECT * FROM d_publication_year";
	
	$result = $mysqli -> query($sql) 

	?>
	 <div class="login">    
<form id="login" action="update_d_publication_year.php" method="POST">
	<table id="tb">
		<tr>
			<th>year</th>
		...
		$i=1;
  		...
  		?>
			...
			<tr>
				...
				<td><input type="text" value="<?php echo "$row[1]";?>" name="no_of_publication<?php echo "$i";?>"/>
				</td>
