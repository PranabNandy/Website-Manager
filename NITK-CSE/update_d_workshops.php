...
<h2 style="text-align: center;"><a href="login3.php" > ==== > Go To Dashboard Page  < ==== <a></a></h2>
	...
	for($i=1;$i<=$records;$i++){
		...
		$sql = "UPDATE d_workshops set  Description='$Description[$i]' WHERE ID=$ID[$i] ";
	...
	$sql = "SELECT * FROM d_workshops";
	
	$result = $mysqli -> query($sql) 

	?>
	 <div class="login">    
<form id="login" action="update_d_workshops.php" method="POST">
	<table id="tb">
		<tr>
			<th>ID</th>
			<th>Description</th>
